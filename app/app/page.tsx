...
const SKILLS = [
  {
    slug: "seo-setup",
    name: "Setup Blog SEO Foundation",
    description:
      "A reusable Next.js content system with MDX, Zod validation, metadata helpers, security headers, JSON-LD, sitemap, RSS, and llms.txt — all wired from day one.",
    status: "stable" as const,
    tags: ["Next.js", "SEO", "MDX", "Content"],
    features: [
      "MDX pipeline with Zod frontmatter validation",
      "Centralized metadata and OG image helpers",
      "CSP and security headers in next.config.ts",
      "Automated sitemap, robots.txt, RSS, and llms.txt",
    ],
  },
];
                  ...
                  <div className="flex-1">
                    ...
                    >
                      ...
                      <div className="absolute right-3 opacity-50 group-hover:opacity-100 transition-opacity">
                        <CopyButton textToCopy={`npx skills add dqstartupbuild/skills/library/${skill.slug}`} />
                      </div>
                    </div>
                  </div>
        ...
        <div className="max-w-3xl mx-auto">
          <div ref={addRevealRef} className="reveal">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-text-primary mb-6">
              ...
              <br />
              They&rsquo;re <span className="gradient-text">architectural contracts.</span>
            </h2>
            <div className="space-y-4 text-text-secondary leading-relaxed">
              ...
              <p>
                ...
                structured <code className="mono text-accent" style={{ fontSize: "0.85em" }}>SKILL.md</code>{" "}
...
function CopyButton({ textToCopy }: { textToCopy: string }) {
  ...
  return (
    ...
    >
      {copied ? (
        <svg viewBox="0 0 24 24" fill="none" stroke="var(--success)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5">
          <polyline points="20 6 9 17 4 12" />
        </svg>
      ) : (
